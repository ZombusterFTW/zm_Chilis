...
function wait_to_scare()
{
	...
	self SetHintString( "Witness the meal of evil" ); // add words inside the "" if you would like the hintstring to say something 
